...
export interface ApiDonationDonation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    purchaseNumber: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 1;
      }>;
...
export interface ApiFooterConfigurationFooterConfiguration
  ...
  info: {
    ...
    pluralName: 'footer-configurations';
    singularName: 'footer-configuration';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    footer: Schema.Attribute.Component<'component.footer', false> &
      Schema.Attribute.Required;
    footerComponent: Schema.Attribute.Component<
      'component.footer-component',
      false
    > &
      Schema.Attribute.Required;
    footerStyle: Schema.Attribute.Component<'settings.section-styles', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer-configuration.footer-configuration'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiHeaderConfigurationHeaderConfiguration
  ...
  info: {
    ...
    pluralName: 'header-configurations';
    singularName: 'header-configuration';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    header: Schema.Attribute.Component<'component.header', false> &
      Schema.Attribute.Required;
    headerUp: Schema.Attribute.Component<'component.header-up', false> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::header-configuration.header-configuration'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiWebsiteConfigurationWebsiteConfiguration
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    globalSettings: Schema.Attribute.Component<'settings.global', false> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
